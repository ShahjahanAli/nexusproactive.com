...
export function StatCard({
  ...
  return (
    <div className="group relative overflow-hidden rounded-lg border border-zinc-800/80 bg-zinc-950/80 p-4 transition hover:border-emerald-500/20 sm:p-5">
      ...
      <div className="flex items-start justify-between gap-3">
        ...
        {icon && (
          <div className="rounded border border-zinc-800 bg-zinc-900/80 p-2 text-emerald-500/80">
            {icon}
          </div>
        )}
      </div>
