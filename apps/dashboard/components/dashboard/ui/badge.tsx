...
const variants = {
  ...
  tactical: 'border-emerald-600/30 bg-emerald-950/40 text-emerald-500',
};
...
export function Badge({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 rounded-full border font-medium ${sizes[size]} ${variants[variant]}`}
    >
      {dot && (
